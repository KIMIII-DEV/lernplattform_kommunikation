...
,
  ...
  // LERNFELD 5 - Kundinnen und Kunden im Dialogmarketing betreuen und binden
  {
    ...
    examRelevance: 'high',
    content: `Ein professionelles Beratungsgespräch im Dialogmarketing folgt einem festen 4-Phasen-Modell, um Effizienz und Kundenzufriedenheit sicherzustellen.

**Die 4 Phasen:**
1. **Begrüßung & Kontaktaufbau:** Professionelle Meldung, Identifikation des Anrufers, Beziehungsaufbau.
2. **Bedarfsermittlung:** Einsatz des **Fragetrichters**. Beginn mit offenen Fragen (W-Fragen), um Informationen zu sammeln, Verengung auf geschlossene Fragen zur Bestätigung.
3. **Beratung & Lösung:** Präsentation passender Angebote basierend auf den ermittelten Bedürfnissen. Nutzenargumentation statt reiner Merkmalsaufzählung.
4. **Gesprächsabschluss:** Zusammenfassung der Ergebnisse, Vereinbarung der nächsten Schritte, freundliche Verabschiedung.

**Wichtig für die 1.0:** Der Einsatz von **Gesprächsleitfäden** dient der Qualitätssicherung, darf aber nicht unnatürlich wirken.`,
    keyPoints: ["4-Phasen-Modell (Begrüßung, Bedarf, Lösung, Abschluss)", "Fragetrichter: Von Offen zu Geschlossen", "Nutzenorientierte Argumentation"]
  },
  {
    id: 'lf5-2',
    title: '5.2 Beschwerdemanagement',
    description: 'Umgang mit unzufriedenen Kunden und Reklamationen.',
    examRelevance: 'high',
    content: `Beschwerdemanagement ist ein zentrales Instrument der Kundenbindung. Eine gut gelöste Beschwerde führt oft zu einer höheren Loyalität als ein reibungsloser Ablauf.

**Kernbegriffe:**
- **Reklamation:** Rechtlich begründeter Anspruch aufgrund eines Sach- oder Rechtsmangels.
- **Beschwerde:** Artikulation von Unzufriedenheit über subjektiv empfundenes Fehlverhalten oder mangelnden Service.

**L-E-S-T Regel für die Gesprächsführung:**
- **L**isten (Zuhören): Ausreden lassen, aktiv zuhören.
- **E**mpathize (Empathie): Verständnis zeigen, ohne sofort Schuld einzugestehen.
- **S**olve (Lösen): Gemeinsame Lösung finden oder anbieten.
- **T**hank (Danken): Für das Feedback danken (Beschwerde als Chance).

**Fehlervermeidung:** Keine Rechtfertigungen, kein Abwälzen der Schuld auf andere Abteilungen, kein Widersprechen bei subjektiven Empfindungen.`,
    keyPoints: ["Unterscheidung Reklamation vs. Beschwerde", "Deeskalation durch die L-E-S-T Regel", "Positives Formulieren zur Deeskalation"]
  },
  {
    id: 'lf5-3',
    title: '5.3 Erfolgskennzahlen (KPIs)',
    description: 'Messung und Steuerung der Leistung im Service Center.',
    examRelevance: 'high',
    content: `Kennzahlen dienen der objektiven Bewertung der Effizienz und Qualität im Dialogmarketing.
...
**Outbound-Kennzahlen:**
- **Ausschöpfungsquote:** Verhältnis von Nettokontakten (Zielperson erreicht) zu Bruttokontakten (Gesamtadressen).
- **Conversion Rate (Erfolgsquote):** Anteil der Abschlüsse an den Nettokontakten.

**Prüfungsfalle:** Bruttokontakte beinhalten auch Fehlversuche (Besetzt, AB). Die Erfolgsquote bezieht sich immer auf die tatsächlich erreichten Personen (Netto).`,
    keyPoints: ["AHT = Talk + Hold + ACW", "Servicelevel als Maß für Erreichbarkeit", "FCR als Qualitätsindikator"]
  },
  {
    id: 'lf5-4',
    title: '5.4 CRM & Kundenbindung',
    description: 'Strategien zur langfristigen Sicherung der Kundenbeziehung.',
    examRelevance: 'medium',
    content: `Customer Relationship Management (CRM) ist eine kundenorientierte Unternehmensstrategie, die durch IT-Systeme unterstützt wird.

**Ziele des CRM:**
- **Identifikation:** Wer sind unsere Kunden?
- **Differenzierung:** Wer sind die wertvollsten Kunden? (Einsatz der **ABC-Analyse**).
- **Interaktion:** Dialog aufbauen.
- **Personalisierung:** Individuelle Angebote erstellen.

**Instrumente:**
- **Kundenwert:** Ermittlung durch Umsatz, Potenzial, Referenzwert und Informationswert.
- **Churn-Prävention:** Haltegespräche führen, bevor der Kunde kündigt.
- **Win-Back:** Rückgewinnung bereits abgewanderter Kunden.`,
    keyPoints: ["ABC-Analyse zur Kundensegmentierung", "Unterscheidung Haltegespräch vs. Win-Back", "CRM als Strategie, nicht nur als Software"]
  },
  {
    id: 'lf5-5',
    title: '5.5 Zahlungsverkehr & Bonität',
    description: 'Sicherung der Zahlungseingänge und Prüfung der Kundenwürdigkeit.',
    examRelevance: 'medium',
    content: `Im Dialogmarketing muss das Risiko von Zahlungsausfällen minimiert werden.

**Bonitätsprüfung:**
- Einholung von Auskünften bei Wirtschaftsauskunfteien (z.B. **SCHUFA**).
- Prüfung des bisherigen Zahlungsverhaltens (internes Scoring).

**Zahlungsarten:**
- **Sichere Arten (für das Unternehmen):** Vorkasse, Nachnahme, Lastschrift (mit Mandat).
- **Unsichere Arten:** Rechnung (Vorleistung durch das Unternehmen).

**SEPA-Lastschrift:**
- Erfordert ein schriftliches Mandat.
- Widerspruchsfrist: 8 Wochen bei autorisierten Zahlungen, 13 Monate bei fehlendem Mandat.`,
    keyPoints: ["Bonitätsprüfung zur Risikominimierung", "Unterschiedliche Sicherheit von Zahlungsarten", "Fristen im SEPA-Verfahren"]
  },
];
...
,
  ...
  {
    id: 'lf5-q1',
    question: 'Ein Inbound-Projekt weist folgende Daten auf: Gesprächszeit 180s, Haltezeit 20s, Nachbearbeitung 40s. Insgesamt wurden 100 Calls bearbeitet. Wie hoch ist die AHT?',
    type: 'multiple-choice',
    options: ["180 Sekunden", "200 Sekunden", "240 Sekunden", "2,4 Minuten"],
    correctAnswer: "240 Sekunden",
    explanation: 'AHT = (180 + 20 + 40) / 1 = 240 Sekunden. Die Anzahl der Calls (100) dient hier nur zur Verwirrung, wenn man den Durchschnitt pro Call berechnet.',
    difficulty: 'medium',
    category: 'Kennzahlen'
  },
  {
    id: 'lf5-q2',
    question: 'Welche der folgenden Maßnahmen verbessert direkt die FCR-Quote (First Call Resolution)?',
    type: 'multiple-choice',
    options: ["Verkürzung der Nachbearbeitungszeit", "Einführung von Skill-Based-Routing", "Erhöhung der Taktzahl im Dialer", "Reduzierung der durchschnittlichen Gesprächszeit"],
    correctAnswer: "Einführung von Skill-Based-Routing",
    explanation: 'Skill-Based-Routing leitet Kunden direkt zum Experten. Das erhöht die Chance, dass das Problem sofort gelöst wird.',
    difficulty: 'medium',
    category: 'Kennzahlen'
  },
  {
    id: 'lf5-q3',
    question: 'Ein Kunde beschwert sich aggressiv über eine falsche Rechnung. Welche Formulierung ist gemäß dem positiven Beschwerdemanagement korrekt?',
    type: 'multiple-choice',
    options: ["Da haben die Kollegen in der Buchhaltung wohl einen Fehler gemacht.", "Ich kann Ihren Ärger verstehen. Lassen Sie uns gemeinsam die Positionen prüfen, um den Fehler zu korrigieren.", "Beruhigen Sie sich bitte, ich kann sonst nicht mit Ihnen arbeiten.", "Das ist unmöglich, unser System macht keine Fehler bei Rechnungen."],
    correctAnswer: "Ich kann Ihren Ärger verstehen. Lassen Sie uns gemeinsam die Positionen prüfen, um den Fehler zu korrigieren.",
    explanation: 'Diese Antwort nutzt Empathie (L-E-S-T) und ist lösungsorientiert, ohne Schuldzuweisungen an Dritte.',
    difficulty: 'medium',
    category: 'Beschwerden'
  },
  {
    id: 'lf5-q4',
    question: 'Berechne die Conversion Rate im Outbound: Bruttokontakte: 1000, Nettokontakte: 400, Abschlüsse: 80.',
    type: 'multiple-choice',
    options: ["8%", "20%", "25%", "40%"],
    correctAnswer: "20%",
    explanation: 'Conversion Rate = (Abschlüsse / Nettokontakte) * 100 = (80 / 400) * 100 = 20%. Bruttokontakte werden nicht berücksichtigt.',
    difficulty: 'hard',
    category: 'Kennzahlen'
  },
  {
    id: 'lf5-q5',
    question: 'Welche Ziele verfolgt die ABC-Analyse im Kundenmanagement? (Mehrfachauswahl möglich)',
    type: 'multiple-choice',
    options: ["Identifikation von A-Kunden mit höchstem Umsatzanteil", "Gleichmäßige Betreuung aller Kunden unabhängig vom Wert", "Effizienter Einsatz von Marketingressourcen", "Automatisierung des Mahnwesens"],
    correctAnswer: "Identifikation von A-Kunden mit höchstem Umsatzanteil",
    explanation: 'Die ABC-Analyse dient der Segmentierung, um Ressourcen dort einzusetzen, wo der größte Hebel (Umsatz/Ertrag) liegt.',
    difficulty: 'medium',
    category: 'CRM'
  },
  {
    id: 'lf5-q6',
    question: 'Ein Kunde möchte per Lastschrift bezahlen, hat aber kein schriftliches Mandat erteilt. Wie lange kann er der Abbuchung widersprechen?',
    type: 'multiple-choice',
    options: ["6 Wochen", "8 Wochen", "13 Monate", "Gar nicht"],
    correctAnswer: "13 Monate",
    explanation: 'Bei einer unautorisierten Lastschrift (kein Mandat) beträgt die Widerspruchsfrist 13 Monate.',
    difficulty: 'hard',
  ...
  {
    id: 'lf5-q8',
    question: 'Was ist der Hauptvorteil eines CRM-Systems für den Agenten im Inbound?',
    type: 'multiple-choice',
    options: ["Automatische Gesprächsaufzeichnung", "Screen-Pop-up mit Kundenhistorie bei Anrufeingang", "Überwachung der Pausenzeiten", "Schnellere Hardware-Anbindung"],
    correctAnswer: "Screen-Pop-up mit Kundenhistorie bei Anrufeingang",
    explanation: 'Durch CTI-Anbindung sieht der Agent sofort, wer anruft und was bisher geschah (Effizienz + Qualität).',
    difficulty: 'medium',
    category: 'CRM'
  },
];
